...
<head>
    ...
    <script>
        if (localStorage.theme === 'dark' || (!localStorage.theme && window.matchMedia('(prefers-color-scheme: dark)')
                .matches)) {
...
<body class="leading-normal tracking-normal text-[#1f2937]">
    <!--Nav-->
    @if (Route::has('login'))
    ...
    <!-- Hero -->
    <section class="hero min-h-[80vh] relative z-10">
        <div class="hero-content relative flex-col lg:flex-row-reverse gap-16">

            <!-- Floating Logo -->
            <div
                class="hidden lg:flex absolute
                   top-0 right-0
                   items-center justify-center
                   opacity-10 pointer-events-none">
                <a href="{{ route('dashboard') }}">
                    <img width="400" height="100" src="{{ asset('logo.webp') }}" alt="Logo Background">
                </a>
            </div>
            ...
            <div class="max-w-full">
                ...
                <h1 class="text-5xl lg:text-7xl font-black leading-tight">
                    <span class="text-accent">Office</span>
                    <span class="text-primary">Time</span>
                </h1>

                <h2 class="text-2xl lg:text-4xl font-light text-secondary mt-2">
                    Track Employee Hours and Boost Productivity
                </h2>

                <p class="py-8 text-base-content/70 leading-relaxed">
                    Helping startups and creators grow through SEO,
                    social media strategy, branding, and high-converting
                    digital campaigns.
                </p>
    ...
    <!-- Articles -->
    <section class="px-6 lg:px-12 pb-20 relative z-10">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-base-content/60 mt-2">
                    Insights about marketing, SEO and digital growth.
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <!-- Card -->
            <div
                class="card bg-base-200/70 backdrop-blur border border-base-300 shadow-xl hover:shadow-primary/20 transition-all duration-300">
                ...
                <div class="card-body">
                    ...
                    <h2 class="card-title text-xl">
                        Boosting Sales with Effective Search Engine Optimization
                    </h2>

                    <p class="text-base-content/60">
                        Improve visibility and attract quality traffic
                        with proven SEO strategies.
                    </p>

                    <div class="card-actions justify-end mt-4">
                        <button class="btn btn-sm btn-primary btn-outline rounded-full">
                            Read More
                        </button>
                    </div>
                </div>
            ...
            <!-- Card -->
            <div
                class="card bg-base-200/70 backdrop-blur border border-base-300 shadow-xl hover:shadow-secondary/20 transition-all duration-300">
                ...
                <div class="card-body">
                    ...
                    <p class="text-base-content/60">
                        Create stronger engagement and build a loyal
            ...
            <!-- Card -->
            <div
                class="card bg-base-200/70 backdrop-blur border border-base-300 shadow-xl hover:shadow-accent/20 transition-all duration-300">
                ...
                <div class="card-body">
                    ...
                    <h2 class="card-title text-xl">
                        Strategies to Boost Sales Through Your Website
                    </h2>

                    <p class="text-base-content/60">
                        Learn conversion-focused design techniques
                        that turn visitors into customers.
                    </p>

                    <div class="card-actions justify-end mt-4">
                        <button class="btn btn-sm btn-accent btn-outline rounded-full">
                            Read More
                        </button>
                    </div>
                </div>
