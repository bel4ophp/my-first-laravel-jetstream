...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    {{-- <body class="gradient bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col"> --}}
    <body class="leading-normal tracking-normal text-[#1f2937] dark:text-gray-200 gradient dark:bg-gradient-dark">
        <!--Nav-->
         @if (Route::has('login'))
        ...
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <img class="w-full md:w-4/5 z-50" src="{{ asset('hero.png') }}" alt="Hero image">
